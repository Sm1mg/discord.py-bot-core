...
def get_embed(interaction: discord.Interaction, title: str=None, description: str=None, *, url: str=None, color: discord.Color|int=None) -> discord.Embed:
    """
...
async def send(interaction: discord.Interaction, title: str=None, description: str=None, *, url: str=None, color: discord.Color|int=None, ephemeral: bool = False) -> None:
    """
